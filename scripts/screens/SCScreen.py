...
class SCScreen(Screens):
    ...
    def handle_event(self, event):
        if event.type == pygame_gui.UI_BUTTON_START_PRESS:
            ...
            if event.ui_element == self.moonthing_label:
    ...
    def screen_switches(self):
        ...
        if game.selected_clan.sc_bg in constants.LAYOUTS:
            self.layout = constants.LAYOUTS[game.selected_clan.sc_bg]
        else:
        ...
        self.set_disabled_menu_buttons(["sc_screen"])
        ...
        moonthing = game.selected_clan.moonthing
        if moonthing == "moonpool":
        ...
        self.moonthing_label = UISurfaceImageButton(
            ui_scale(pygame.Rect(self.layout["moonthing label"], (100, 28))),
            f"screens.core.{moonthing}",
            get_button_dict(ButtonStyles.ROUNDED_RECT, (100, 28)),
            object_id=ObjectID(class_id="@buttonstyles_rounded_rect", object_id=None),
        )
    ...
    def exit_screen(self):
        ...
        self.moonthing_label.kill()
        del self.moonthing_label
    ...
    def update_sc_bg(self):
        ...
        sc_nr = game.selected_clan.sc_bg

        if sc_nr is None:
            sc_nr = "classic"
            game.clan.sc_bg = sc_nr
        ...
        for bg in bgs:
            platform_dir = (
                f"{sc_bg_base_dir}/sc/{bg}_{light_dark}.png"
            )
    ...
    def choose_cat_positions(self):
        ...
        for x in Cat.all_cats:
            if Cat.all_cats[x].status.group != CatGroup.STARCLAN:
                continue
            ...
            if (
                ...
                if (
                    ...
                    or game_setting_get("ageup newborns")
                ):
                    # Free them
                    [
