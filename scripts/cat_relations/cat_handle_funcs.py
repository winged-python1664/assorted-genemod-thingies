    ...
    for ID in cat.all_cats:
        ...
        if the_cat.ID is not cat.ID:
            ...
            if (
                ...
                or cat.parent2 is not None
                or cat.parent3 is not None
                or the_cat.parent1 is not None
                or the_cat.parent2 is not None
                or the_cat.parent3 is not None
            ):
                are_parents = the_cat.ID in (cat.parent1, cat.parent2, cat.parent3)
                ...
                siblings = cat.parent1 in (
                    ...
                    the_cat.parent2,
                    the_cat.parent3,
                ) or cat.parent2 in (the_cat.parent1, the_cat.parent2, the_cat.parent3
                ) or cat.parent3 in (the_cat.parent1, the_cat.parent2, the_cat.parent3)
            ...
            if game_setting_get("random relation"):
                if (
                    game.clan
                    and the_cat == [game.clan.instructor] + [clan.instructor for clan in game.clan.all_other_clans if clan.instructor]
                    ...
                    and the_cat.status.get_last_living_group() != cat.status.group_ID
                ):
                    pass
                elif (randint(1, 20) == 1 or (cat.status.group_ID != the_cat.status.group_ID and random() < 0.8)) and romance < 1:
                    like += randint(-25, 5)
