...
class TestFocus(unittest.TestCase):
    ...
    def test_sabotage_other_clans(self):
        ...
        starting_relation = game.clan.get_relations(game.clan, game.clan.all_other_clans[0])
        amount = get_config("focus.other_clans.relation")
        focus.handle_focus()

        self.assertEqual(
            starting_relation - amount, game.clan.get_relations(game.clan, game.clan.all_other_clans[0])
        )
